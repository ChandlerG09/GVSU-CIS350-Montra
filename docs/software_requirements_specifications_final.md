...
1. Navigation and Settings:
	...
	3. The settings shall be expandable if requirements change or functionality is added. |TC01|
	4. The app shall include an option for different app layouts(Ex. Dark or Light mode). |TC01|
	5. The app shall include a spot for meditation notes within the settings screen. 
...
3. Base Mantra Funcionality:
	...
	6. The app shall display the time remaining for the current meditation session. |TC03| 
	7. The app shall say a phrase to let the user know the session is over.
...
1. Stored Data:
	...
	4. The app shall be able to have data persist after application close
	5. The app shall store the users meditation notes in the app. 
2. Robustness:
	...
	4. The app shall have a quick start up time with no set up required to get started.
	5. The app shall be available as a web application. 
3. UX:
	...
	5. THe app shall adapt to the size of the device that is being used without the formatting being compromised. 
